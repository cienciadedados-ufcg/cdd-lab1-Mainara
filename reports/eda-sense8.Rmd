...
Analisaremos os episódios das séries Sense 8, Orphan Black e Breaking Bad.
...
episodes = read_csv(here("data/series_from_imdb.csv"), 
    ...
    filter(series_name %in% c("Sense8", "Orphan Black", "Breaking Bad"))
```
...
Para responder essa pergunta precisaremos analisar a avaliação feita pelos usuários para episódio de cada série.
